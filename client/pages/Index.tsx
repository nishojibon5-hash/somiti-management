...
export default function Index() {
  ...
  const text = {
    bn: {
      ...
      description:
        "বাংলাদেশের সবচেয়ে উন্নত ও নিরাপদ সমিতি ব্যবস্থাপনা সমাধান। সহজ, নিরাপদ এবং কার্যকর।",
    ...
    en: {
      ...
      description:
        "Bangladesh's most advanced and secure cooperative management solution. Simple, secure, and effective.",
  ...
  const features = [
    {
      ...
      description:
        language === "bn"
          ? "সম্পূর্ণ সদস্য তথ্য ও লেনদেন ব্যবস্থাপনা"
          : "Complete member information and transaction management",
    },
    {
      ...
      description:
        language === "bn"
          ? "স্বয়ংক্রিয় ঋণ প্রক্রিয়া ও পরিশোধ ট্র্যাকিং"
    ...
    },
    {
      ...
      description:
        language === "bn"
          ? "বিস্তারিত আর্থিক রিপোর্ট ও ডেটা বিশ্��েষণ"
    ...
    },
    {
      ...
      description:
        language === "bn"
          ? "অ্যান্ড্রয়েড ও আইওএস অ্যাপ্লিকেশন"
    ...
    },
    {
      ...
      description:
        language === "bn"
          ? "স্বয়ংক্রিয় ডেটা ব্যাকআপ ও রিকভারি"
      ...
      <section className="py-20 px-4">
        <div className="container mx-auto text-center max-w-4xl">
          <Badge variant="secondary" className="mb-4">
            {language === "bn"
              ? "বাংলাদেশের #১ সমিতি সফটওয়্যার"
              : "Bangladesh's #1 Cooperative Software"}
          </Badge>
          ...
          <div className="grid md:grid-cols-4 gap-8 text-center">
            <div>
              ...
              <div className="text-lg opacity-90">
                {language === "bn" ? "সমিতি" : "Cooperatives"}
              </div>
            </div>
            <div>
